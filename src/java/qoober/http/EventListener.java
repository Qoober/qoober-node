...
class EventListener implements Runnable, AsyncListener, TransactionalDb.TransactionCallback {
    ...
    /** Maximum event users */
    static final int maxEventUsers = Qoober.getIntProperty("qoober.apiMaxEventUsers");

    /** Event registration timeout (seconds) */
    static final int eventTimeout = Math.max(Qoober.getIntProperty("qoober.apiEventTimeout"), 15);

    /** Blockchain processor */
    static final BlockchainProcessor blockchainProcessor = Qoober.getBlockchainProcessor();

    /** Transaction processor */
    static final TransactionProcessor transactionProcessor = Qoober.getTransactionProcessor();
     ...
     *
     * Qoober event listeners will be added for the specified events
     *
     * @param   eventRegistrations      List of Qoober event registrations
     ...
     *
     * @param   eventRegistrations      Qoober event registrations
     * @throws  EventListenerException  Invalid Qoober event
     */
    ...
    private class NxtEventListener {
        ...
        /**
         * Create the Qoober event listener
         *
        ...
        /**
         * Add the Qoober listener for this event
         */
        ...
        /**
         * Remove the Qoober listener for this event
         */
        ...
        /**
         * Return the hash code for this Qoober event listener
         *
         * @return                  Hash code
         */
        @Override
        ...
        /**
         * Check if two Qoober events listeners are equal
         *
        ...
        private abstract class NxtEventHandler {
            ...
            /** Qoober listener event */
            protected final Enum<? extends Enum> event;

            /**
             * Create the Qoober event handler
             *
             * @param   eventRegistration   Event registration
             */
    ...
    static class EventRegistration {
         ...
         *
         * @param   event           Qoober listener event
        ...
        /**
         * Return the Qoober listener event
         *
         * @return                  Qoober listener event
         */
        public Enum<? extends Enum> getEvent() {
            return event;
        }
