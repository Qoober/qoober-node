...
public final class Convert {
    ...
    public static String readString(ByteBuffer buffer, int numBytes, int maxLength) throws QooberException.NotValidException {
        if (numBytes > getMaxStringSize(maxLength)) {
            throw new QooberException.NotValidException("Max parameter length exceeded");
        }
    ...
    public static long parseNXT(String nxt) {
        return parseStringFraction(nxt, 8, Constants.MAX_BALANCE_QBR);
    }
