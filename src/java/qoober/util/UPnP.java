...
public class UPnP {
    ...
    public static synchronized void addPort(int port) {
        ...
        try {
            if (gateway.addPortMapping(port, port, localAddress.getHostAddress(), "TCP",
                                       Qoober.APPLICATION + " " + Qoober.VERSION)) {
    ...
    private static void init() {
        ...
        try {
            ...
            GatewayDevice.setHttpReadTimeout(Qoober.getIntProperty("qoober.upnpGatewayTimeout", GatewayDevice.getHttpReadTimeout()));
            GatewayDiscover discover = new GatewayDiscover();
            discover.setTimeout(Qoober.getIntProperty("qoober.upnpDiscoverTimeout", discover.getTimeout()));
