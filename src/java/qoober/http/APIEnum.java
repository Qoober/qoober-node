...
public enum APIEnum {
    ...
    GET_STRUCT_BALANCE("getStructBalance", GetStructBalance.instance),
    GET_ACCOUNT_PARENT("getAccountParent", GetAccountParent.instance),
    GET_LAST_PARAMINING_START("getLastParaminingStart", GetLastParaminingStart.instance),
    GET_VIRTUAL_PARAMINING_BALANCE("getVirtualParaminingBalance", GetVirtualParaminingBalance.instance),
    ...
    GET_EPOCH_TIME("getEpochTime", GetEpochTime.instance),
		...
		GET_ALL_TRANSACTIONS("getAllTransactions", GetAllTransactions.instance),
		GET_EXPLORER_STATS("getExplorerStats", GetExplorerStats.instance);
