    ...
    private static final class Holder {
        ...
        static {
            try {
                ...
                response.put("genesisBlockId", Long.toUnsignedString(Qoober.getBlockchainProcessor().getGenesisBlockId()));
                ...
                response.put("initialBaseTarget", Long.toUnsignedString(Constants.INITIAL_BASE_TARGET));
								...
								response.put("disabledAdminPassword", Qoober.getBooleanProperty("qoober.disableAdminPassword") ? 1 : 0);
