...
public interface Transaction {
    ...
    interface Builder {
        ...
        Transaction build() throws QooberException.NotValidException;

        Transaction build(String secretPhrase) throws QooberException.NotValidException;
    ...
    void validate() throws QooberException.ValidationException;
