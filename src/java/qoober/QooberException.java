...
public abstract class QooberException extends Exception {

    protected QooberException() {
        super();
    }

    protected QooberException(String message) {
        super(message);
    }

    protected QooberException(String message, Throwable cause) {
        super(message, cause);
    }

    protected QooberException(Throwable cause) {
        super(cause);
    }

    public static abstract class ValidationException extends QooberException {
