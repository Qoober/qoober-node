...
/**
 * Handle logging for the Qoober node server
 */
public final class Logger {
    ...
    static {
        ...
        System.setProperty("java.util.logging.manager", "qoober.util.QooberLogManager");
        if (!(LogManager.getLogManager() instanceof QooberLogManager)) {
            System.setProperty("java.util.logging.manager",
                    (oldManager != null ? oldManager : "java.util.logging.LogManager"));
        }
        if (! Boolean.getBoolean("qoober.doNotConfigureLogging")) {
            try {
                Properties loggingProperties = new Properties();
                Qoober.loadProperties(loggingProperties, "logging-default.properties", true);
                Qoober.loadProperties(loggingProperties, "logging.properties", false);
                Qoober.updateLogFileHandler(loggingProperties);
        ...
        log = org.slf4j.LoggerFactory.getLogger(Qoober.class);
        enableStackTraces = Qoober.getBooleanProperty("qoober.enableStackTraces");
        enableLogTraceback = Qoober.getBooleanProperty("qoober.enableLogTraceback");
    ...
    public static void shutdown() {
        if (LogManager.getLogManager() instanceof QooberLogManager) {
            ((QooberLogManager) LogManager.getLogManager()).nxtShutdown();
        }
    }
