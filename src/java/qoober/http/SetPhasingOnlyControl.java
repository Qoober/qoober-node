 ...
 *  <li>NQT(1) Qoober balance threshold</li>
...
public final class SetPhasingOnlyControl extends CreateTransaction {
    ...
    @Override
    protected JSONStreamAware processRequest(HttpServletRequest request) throws QooberException {
        Account account = ParameterParser.getSenderAccount(request);
        PhasingParams phasingParams = parsePhasingParams(request, "control");
        long maxFees = ParameterParser.getLong(request, "controlMaxFees", 0, Constants.MAX_BALANCE_QNT, false);
