 ...
 * Constraints
 * <p>
 * This API is allowed only when the currency is {@link qoober.CurrencyType#RESERVABLE} and is not yet active.
 * <p>
 ...
 * The list of founders and their NQT investment can be obtained using the {@link qoober.http.GetCurrencyFounders} API.
 */
...
public final class CurrencyReserveIncrease extends CreateTransaction {
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws QooberException {
        ...
        long amountPerUnitNQT = ParameterParser.getLong(req, "amountPerUnitNQT", 1L, Constants.MAX_BALANCE_QNT, true);
