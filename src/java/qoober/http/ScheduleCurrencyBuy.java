    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws QooberException {
        ...
        try {
            ...
            if (transactionBytes == null && transactionJSON == null) {
                ...
                transaction = Qoober.newTransactionBuilder((JSONObject) response.get("transactionJSON")).build();
            } else {
            ...
            try {
                ...
                try (DbIterator<? extends Transaction> unconfirmedTransactions = Qoober.getTransactionProcessor().getAllUnconfirmedTransactions()) {
