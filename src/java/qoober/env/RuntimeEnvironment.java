...
public class RuntimeEnvironment {
    ...
    public static final String RUNTIME_MODE_ARG = "qoober.runtime.mode";
    public static final String DIRPROVIDER_ARG = "qoober.runtime.dirProvider";
    ...
    public static RuntimeMode getRuntimeMode() {
        ...
        if (isDesktopEnabled()) {
            ...
            try {
                return (RuntimeMode) Class.forName("qoober.env.AndroidServiceMode").newInstance();
