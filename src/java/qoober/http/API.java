...
import static qoober.http.JSONResponses.INCORRECT_ADMIN_PASSWORD;
import static qoober.http.JSONResponses.LOCKED_ADMIN_PASSWORD;
import static qoober.http.JSONResponses.MISSING_ADMIN_PASSWORD;
import static qoober.http.JSONResponses.NO_PASSWORD_IN_CONFIG;
...
public final class API {
    ...
    public static final String adminPassword = Qoober.getStringProperty("qoober.adminPassword", "", true);
    static final boolean disableAdminPassword;
    static final int maxRecords = Qoober.getIntProperty("qoober.maxAPIRecords");
    static final boolean enableAPIUPnP = Qoober.getBooleanProperty("qoober.enableAPIUPnP");
    public static final int apiServerIdleTimeout = Qoober.getIntProperty("qoober.apiServerIdleTimeout");
    public static final boolean apiServerCORS = Qoober.getBooleanProperty("qoober.apiServerCORS");
    private static final String forwardedForHeader = Qoober.getStringProperty("qoober.forwardedForHeader");
    ...
    static {
        List<String> allowedBotHostsList = Qoober.getStringListProperty("qoober.allowedBotHosts");
        ...
        boolean enableAPIServer = Qoober.getBooleanProperty("qoober.enableAPIServer");
        if (enableAPIServer) {
            final int port = Constants.isTestnet ? TESTNET_API_PORT : Qoober.getIntProperty("qoober.apiServerPort");
            final int sslPort = Constants.isTestnet ? TESTNET_API_SSLPORT : Qoober.getIntProperty("qoober.apiServerSSLPort");
            final String host = Qoober.getStringProperty("qoober.apiServerHost");
            disableAdminPassword = Qoober.getBooleanProperty("qoober.disableAdminPassword") || ("127.0.0.1".equals(host) && adminPassword.isEmpty());

            apiServer = new Server();
            ServerConnector connector;
            boolean enableSSL = Qoober.getBooleanProperty("qoober.apiSSL");
            //
            ...
            if (enableSSL) {
                ...
                String keyStorePath = Paths.get(Qoober.getUserHomeDir()).resolve(Paths.get(Qoober.getStringProperty("qoober.keyStorePath"))).toString();
                Logger.logInfoMessage("Using keystore: " + keyStorePath);
                sslContextFactory.setKeyStorePath(keyStorePath);
                sslContextFactory.setKeyStorePassword(Qoober.getStringProperty("qoober.keyStorePassword", null, true));
                ...
                sslContextFactory.setKeyStoreType(Qoober.getStringProperty("qoober.keyStoreType"));
                List<String> ciphers = Qoober.getStringListProperty("qoober.apiSSLCiphers");
                if (!ciphers.isEmpty()) {
            ...
            String apiResourceBase = Qoober.getStringProperty("qoober.apiResourceBase");
            if (apiResourceBase != null) {
                ...
                apiHandler.setWelcomeFiles(new String[]{Qoober.getStringProperty("qoober.apiWelcomeFile")});
            }

            String javadocResourceBase = Qoober.getStringProperty("qoober.javadocResourceBase");
            ...
            servletHolder.getRegistration().setMultipartConfig(new MultipartConfigElement(
                    null, Math.max(Qoober.getIntProperty("qoober.maxUploadFileSize"), Constants.MAX_TAGGED_DATA_DATA_LENGTH), -1L, 0));
            ...
            if (!Qoober.getBooleanProperty("qoober.enableAPIServerGZIPFilter", isOpenAPI)) {
                gzipHandler.setExcludedPaths("/qoober", "/nxt-proxy");
            }
            gzipHandler.setIncludedMethods("GET", "POST");
            gzipHandler.setMinGzipSize(qoober.peer.Peers.MIN_COMPRESS_SIZE);
            ...
            if (Qoober.getBooleanProperty("qoober.apiFrameOptionsSameOrigin")) {
                FilterHolder filterHolder = apiHandler.addFilter(XFrameOptionsFilter.class, "/*", null);
                filterHolder.setAsyncSupported(true);
            }
            disableHttpMethods(apiHandler);

            String customAPISetupImplClassName = Convert.emptyToNull(Qoober.getStringProperty("qoober.apiCustomSetupImpl"));
    ...
    public static void init() {
        if (!isInitialized) {
            isInitialized = true;
            List<String> disabled = new ArrayList<>(Qoober.getStringListProperty("qoober.disabledAPIs"));
            ...
            disabled = Qoober.getStringListProperty("qoober.disabledAPITags");
