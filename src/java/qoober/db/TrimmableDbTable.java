...
public class TrimmableDbTable<T> extends DerivedDbTable {
    ...
    public TrimmableDbTable(String table, DbKey.Factory<T> dbKeyFactory, boolean multiversion) {
        super(table);
        this.dbKeyFactory = dbKeyFactory;
        this.multiversion = multiversion;
        this.trimFrequency = Qoober.getIntProperty("qoober.trimFrequencyMultiplier." + table, 1);
