 ...
 * For {@link qoober.CurrencyType#RESERVABLE} currency
 ...
 * For {@link qoober.CurrencyType#MINTABLE} currency
 * <li>maxDifficulty - for mint-able currency, the exponent of the final difficulty.
 * For {@link qoober.CurrencyType#MINTABLE} currency
 * <li>algorithm - the hashing {@link qoober.crypto.HashFunction algorithm} used for minting.
 * For {@link qoober.CurrencyType#MINTABLE} currency
 * </ul>
 * <p>
 * Constraints
 * <ul>
 * <li>A given currency can not be neither {@link qoober.CurrencyType#EXCHANGEABLE} nor {@link qoober.CurrencyType#CLAIMABLE}.<br>
 * <li>A {@link qoober.CurrencyType#RESERVABLE} currency becomes active once the blockchain height reaches the currency issuance height.<br>
 ...
 * When a {@link qoober.CurrencyType#RESERVABLE} becomes active, in case it is {@link qoober.CurrencyType#CLAIMABLE} the NXT used for
 * reserving the currency are locked until they are claimed back.
 * When a {@link qoober.CurrencyType#RESERVABLE} becomes active, in case it is non {@link qoober.CurrencyType#CLAIMABLE} the NXT used for
 * reserving the currency are sent to the issuer account as crowd funding.
 * <li>When issuing a {@link qoober.CurrencyType#MINTABLE} currency, the number of units per {@link qoober.http.CurrencyMint} cannot exceed 0.01% of the
 ...
 * difficulty increases linearly with the number units minted per {@link qoober.http.CurrencyMint}<br>
 * </ul>
 *
 * @see qoober.CurrencyType
 * @see qoober.crypto.HashFunction
 */
public final class IssueCurrency extends CreateTransaction {
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws QooberException {
        ...
        long minReservePerUnit = ParameterParser.getLong(req, "minReservePerUnitNQT", 1, Constants.MAX_BALANCE_QNT, false);
