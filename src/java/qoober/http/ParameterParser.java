...
import static qoober.http.JSONResponses.INCORRECT_ACCOUNT;
import static qoober.http.JSONResponses.INCORRECT_ALIAS;
import static qoober.http.JSONResponses.INCORRECT_ARBITRARY_MESSAGE;
import static qoober.http.JSONResponses.INCORRECT_DATA_TOO_LONG;
import static qoober.http.JSONResponses.INCORRECT_DATA_ZERO_LENGTH;
import static qoober.http.JSONResponses.INCORRECT_HEIGHT;
import static qoober.http.JSONResponses.INCORRECT_MESSAGE_TO_ENCRYPT;
import static qoober.http.JSONResponses.INCORRECT_PURCHASE;
import static qoober.http.JSONResponses.INCORRECT_TAGGED_DATA_CHANNEL;
import static qoober.http.JSONResponses.INCORRECT_TAGGED_DATA_DESCRIPTION;
import static qoober.http.JSONResponses.INCORRECT_TAGGED_DATA_FILE;
import static qoober.http.JSONResponses.INCORRECT_TAGGED_DATA_FILENAME;
import static qoober.http.JSONResponses.INCORRECT_TAGGED_DATA_NAME;
import static qoober.http.JSONResponses.INCORRECT_TAGGED_DATA_TAGS;
import static qoober.http.JSONResponses.INCORRECT_TAGGED_DATA_TYPE;
import static qoober.http.JSONResponses.MISSING_ACCOUNT;
import static qoober.http.JSONResponses.MISSING_ALIAS_OR_ALIAS_NAME;
import static qoober.http.JSONResponses.MISSING_NAME;
import static qoober.http.JSONResponses.MISSING_PROPERTY;
import static qoober.http.JSONResponses.MISSING_RECIPIENT_PUBLIC_KEY;
import static qoober.http.JSONResponses.MISSING_SECRET_PHRASE;
import static qoober.http.JSONResponses.MISSING_TRANSACTION_BYTES_OR_JSON;
import static qoober.http.JSONResponses.UNKNOWN_ACCOUNT;
import static qoober.http.JSONResponses.UNKNOWN_ALIAS;
import static qoober.http.JSONResponses.UNKNOWN_ASSET;
import static qoober.http.JSONResponses.UNKNOWN_CURRENCY;
import static qoober.http.JSONResponses.UNKNOWN_GOODS;
import static qoober.http.JSONResponses.UNKNOWN_OFFER;
import static qoober.http.JSONResponses.UNKNOWN_POLL;
import static qoober.http.JSONResponses.UNKNOWN_SHUFFLING;
import static qoober.http.JSONResponses.either;
import static qoober.http.JSONResponses.incorrect;
import static qoober.http.JSONResponses.missing;
...
public final class ParameterParser {
    ...
    public static long getAmountNQT(HttpServletRequest req) throws ParameterException {
        return getLong(req, "amountNQT", 1L, Constants.MAX_BALANCE_QNT, true);
    }

    public static long getFeeNQT(HttpServletRequest req) throws ParameterException {
        return getLong(req, "feeNQT", 0L, Constants.MAX_BALANCE_QNT, true);
    }

    public static long getPriceNQT(HttpServletRequest req) throws ParameterException {
        return getLong(req, "priceNQT", 1L, Constants.MAX_BALANCE_QNT, true);
    }
    ...
    public static long getAmountNQTPerQNT(HttpServletRequest req) throws ParameterException {
        return getLong(req, "amountNQTPerQNT", 1L, Constants.MAX_BALANCE_QNT, true);
    }
    ...
    public static int getNumberOfConfirmations(HttpServletRequest req) throws ParameterException {
        return getInt(req, "numberOfConfirmations", 0, Qoober.getBlockchain().getHeight(), false);
    }
    ...
    public static int getHeight(HttpServletRequest req, boolean isMandatory) throws ParameterException {
        ...
        if (heightValue != null) {
            try {
                ...
                if (height < 0 || height > Qoober.getBlockchain().getHeight()) {
    ...
    public static Transaction.Builder parseTransaction(String transactionJSON, String transactionBytes, String prunableAttachmentJSON) throws ParameterException {
        ...
        if (transactionJSON != null) {
            try {
                ...
                return Qoober.newTransactionBuilder(json);
            } catch (QooberException.ValidationException | RuntimeException | ParseException e) {
            ...
            try {
                ...
                return Qoober.newTransactionBuilder(bytes, prunableAttachments);
            } catch (QooberException.ValidationException|RuntimeException | ParseException e) {
                Logger.logDebugMessage(e.getMessage(), e);
                JSONObject response = new JSONObject();
    ...
    public static Attachment.TaggedDataUpload getTaggedData(HttpServletRequest req) throws ParameterException, QooberException.NotValidException {
