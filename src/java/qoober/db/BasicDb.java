...
import qoober.db.pool.ConnectionPool;
import qoober.db.pool.H2ConnectionPool;
...
public class BasicDb {
    ...
    public BasicDb(DbProperties dbProperties) {
        ...
        if (dbUrl == null) {
            String dbDir = Qoober.getDbDir(dbProperties.dbDir);
    ...
    public void init(DbVersion dbVersion) {
        ...
        String implClassName = Qoober.getStringProperty("qoober.connectionPoolImpl");
    ...
    public void shutdown() {
        ...
        try {
            ...
            Statement stmt = con.createStatement();
            boolean compact = ! Qoober.getBooleanProperty("qoober.disableCompactOnShutdown");
            if (compact) {
