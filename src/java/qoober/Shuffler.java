...
public final class Shuffler {
    ...
    private static final int MAX_SHUFFLERS = Qoober.getIntProperty("qoober.maxNumberOfShufflers");
    ...
    private static void scheduleExpiration(Shuffling shuffling) {
        int expirationHeight = Qoober.getBlockchain().getHeight() + 720;
    ...
    private volatile QooberException.NotCurrentlyValidException failureCause;
    ...
    public QooberException.NotCurrentlyValidException getFailureCause() {
        return failureCause;
    }
    ...
    private void submitTransaction(Attachment.ShufflingAttachment attachment) {
        ...
        try {
            Transaction.Builder builder = Qoober.newTransactionBuilder(Crypto.getPublicKey(secretPhrase), 0, 0,
                    (short) 1440, attachment);
            builder.timestamp(Qoober.getBlockchain().getLastBlockTimestamp());
            ...
            if (participantAccount == null || transaction.getFeeNQT() > participantAccount.getUnconfirmedBalanceNQT()) {
                ...
                failureCause = new QooberException.NotCurrentlyValidException("Insufficient balance");
    ...
    public static class ShufflerException extends QooberException {
